function  xy=triplane(coefP, coefT, combo, lat, lon)
...
%
function F = parameterplane(x,a,b,z)

F(1)=a(1)*x(1)+a(2)*x(2)+a(3)-z(1);
F(2)=b(1)*x(1)+b(2)*x(2)+b(3)-z(2);
